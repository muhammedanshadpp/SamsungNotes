...
class UpdatesNotes extends HookWidget {
  final int index;
  final Notes notess;
  final Function(int, String, String) onUpdated;
  final Function(int) moveToRecycleBin; // Function to move note to recycle bin

  UpdatesNotes(
      {required this.notess,
      required this.index,
      required this.onUpdated,
      required this.moveToRecycleBin});

  @override
  Widget build(BuildContext context) {
    final titlecontroller = useTextEditingController(text: notess.title);
    final bodycontroller = useTextEditingController(text: notess.body);
